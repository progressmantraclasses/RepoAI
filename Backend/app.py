# !pip install fastapi uvicorn numpy pydantic pickle5 langchain langchain-community langchain-nomic serpapi nomic PyPDF2 faiss-cpu scikit-learn pdfplumber
